...
* Bradley Anderegg
*/
#ifndef DELTA_SIMPLESCENE_H
#define DELTA_SIMPLESCENE_H
...
namespace dtRender
{
   class DT_RENDER_EXPORT SimpleScene : public SceneBase
   {
   public:
      typedef SceneBase BaseClass;
      static const dtCore::RefPtr<SceneType> SIMPLE_SCENE;
