...
#ifndef LOAD_GUI_CURSOR_ACTION_NODE
#define LOAD_GUI_CURSOR_ACTION_NODE
...
{
   ////////////////////////////////////////////////////////////////////////////////
   class GUI_NODE_LIBRARY_EXPORT SetGUICursor: public ActionNode
   {
   public:
       ...
       */
      void SetImageSet(const std::string& value);
      std::string GetImageSet();
...
#endif // SET_GUI_SCHEME_ACTION_NODE
