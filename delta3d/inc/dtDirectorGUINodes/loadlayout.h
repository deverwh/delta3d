...
#ifndef LOAD_LAYOUT_ACTION_NODE
#define LOAD_LAYOUT_ACTION_NODE
...
{
   ////////////////////////////////////////////////////////////////////////////////
   class GUI_NODE_LIBRARY_EXPORT LoadLayout: public ActionNode
   {
   public:
      ...
      void SetShowImmediately(bool value);
      bool GetShowImmediately() const;
   ...
   private:
      ...
      std::string mLayout;
      bool        mShowImmediately;
   };
}

////////////////////////////////////////////////////////////////////////////////

#endif // LOAD_LAYOUT_ACTION_NODE
