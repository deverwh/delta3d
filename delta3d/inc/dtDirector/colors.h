...
{
   class DT_DIRECTOR_EXPORT Colors
   {
      public:
         ...
         static const osg::Vec3 GREEN3;
         static const osg::Vec3 BLUE;
         static const osg::Vec3 BLUE2;
         static const osg::Vec3 BLUE3;
         static const osg::Vec3 ORANGE;
         static const osg::Vec3 YELLOW;
         static const osg::Vec3 VIOLET;
         static const osg::Vec3 CYAN;
