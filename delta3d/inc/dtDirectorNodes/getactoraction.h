...
#ifndef GET_ACTOR_ACTION_NODE
#define GET_ACTOR_ACTION_NODE
...
{
   ////////////////////////////////////////////////////////////////////////////////
   class NODE_LIBRARY_EXPORT GetActorAction: public ActionNode
   {
   public:
      ...
      void SetActor(const dtCore::UniqueId& value);
      dtCore::UniqueId GetActor() const;
...
#endif // GET_ACTOR_PROPERTY_ACTION_NODE
