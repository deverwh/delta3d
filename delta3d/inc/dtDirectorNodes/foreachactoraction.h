...
#ifndef FOR_EACH_ACTOR_ACTION_NODE
#define FOR_EACH_ACTOR_ACTION_NODE
...
{
   ////////////////////////////////////////////////////////////////////////////////
   class NODE_LIBRARY_EXPORT ForEachActorAction: public ActionNode
   {
   public:
      ...
      dtCore::UniqueId GetCurrentActor() const;
...
#endif // FOR_EACH_ACTOR_ACTION_NODE
