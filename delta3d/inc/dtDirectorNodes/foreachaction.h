...
#ifndef FOR_EACH_ACTION_NODE
#define FOR_EACH_ACTION_NODE
...
{
   ////////////////////////////////////////////////////////////////////////////////
   class NODE_LIBRARY_EXPORT ForEachAction: public ActionNode
   {
   public:
       ...
       */
      void SetItemArray(int value);
      int GetItemArray() const;
