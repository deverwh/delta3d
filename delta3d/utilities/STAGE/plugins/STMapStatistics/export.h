#ifndef DELTA_MAP_STATISTICS_EXPORT
#define DELTA_MAP_STATISTICS_EXPORT
...
#  ifdef DT_MAP_STATISTICS_PLUGIN
#    define DT_MAP_STATISTICS_EXPORT __declspec(dllexport)
#  else
#    define DT_MAP_STATISTICS_EXPORT __declspec(dllimport)
#  endif
#else
#  ifdef DT_MAP_STATISTICS_PLUGIN
#    define DT_MAP_STATISTICS_EXPORT  __attribute__ ((visibility("default")))
#  else
#    define DT_MAP_STATISTICS_EXPORT
#  endif
#endif
