...
#include "ArchiveExtended"

#include "unzip.h"


class ZipArchive : public osgDB::ArchiveExtended
{
    public:
        ZipArchive();
        virtual ~ZipArchive();
        ...
        * returns an empty array on any error.*/
        ...
        virtual osgDB::ReaderWriter::ReadResult readShader(const std::string& /*fileName*/,const Options* =NULL) const;
        ...
        virtual osgDB::ReaderWriter::WriteResult writeShader(const osg::Shader& /*shader*/,const std::string& /*fileName*/,const Options* =NULL) const;
