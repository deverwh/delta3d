...
public class ApplicationConfiguration
{
	...
	public Boolean ParseConfigFile()
	{
		...
		{
			JavaExeLaunch.logger.warning("Invalid URL for application config xml file");
			return false;
		}
		catch (IOException e)
		{
			JavaExeLaunch.logger.warning("Could not access config xml file");
			return false;
		}
		...
		{
			JavaExeLaunch.logger.warning("JavaLaunch SAXException: " + e.getMessage());
			return false;
		}
		catch (ParserConfigurationException e)
		{
			JavaExeLaunch.logger.warning("JavaLaunch ParserConfigurationException: " + e.getMessage());
			return false;
		}
		catch (IOException e)
		{
			JavaExeLaunch.logger.warning("JavaLaunch IOException: " + e.getMessage());
			return false;
		}
