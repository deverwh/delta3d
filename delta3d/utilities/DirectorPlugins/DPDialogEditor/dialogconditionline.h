#ifndef DIRECTOR_DIALOG_CONDITION_LINE_TYPE
#define DIRECTOR_DIALOG_CONDITION_LINE_TYPE

#include <export.h>
#include <dialoglinetype.h>

////////////////////////////////////////////////////////////////////////////////
class DT_DIRECTOR_DIALOG_EDITOR_EXPORT DialogConditionLineType: public DialogLineType
{
public:

   DialogConditionLineType();
   virtual ~DialogConditionLineType(void);
   ...
   /**
    * Retrieves whether this line contains multiple choices.
    */
    ...
    */
   virtual int GetChoiceLimit() const {return 2;}
...
#endif //DIRECTOR_DIALOG_CONDITION_LINE_TYPE
