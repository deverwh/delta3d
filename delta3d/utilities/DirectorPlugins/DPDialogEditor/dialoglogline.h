#ifndef DIRECTOR_DIALOG_LOG_LINE_TYPE
#define DIRECTOR_DIALOG_LOG_LINE_TYPE

#include <export.h>
#include <dialoglinetype.h>

////////////////////////////////////////////////////////////////////////////////
class DT_DIRECTOR_DIALOG_EDITOR_EXPORT DialogLogLineType: public DialogLineType
{
public:
   DialogLogLineType();
   virtual ~DialogLogLineType(void);
...
#endif //DIRECTOR_DIALOG_LOG_LINE_TYPE
