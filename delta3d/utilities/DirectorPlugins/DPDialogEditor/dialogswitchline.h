#ifndef DIRECTOR_DIALOG_SWITCH_LINE_TYPE
#define DIRECTOR_DIALOG_SWITCH_LINE_TYPE

#include <export.h>
#include <dialoglinetype.h>

////////////////////////////////////////////////////////////////////////////////
class DT_DIRECTOR_DIALOG_EDITOR_EXPORT DialogSwitchLineType: public DialogLineType
{
public:
   enum SwitchType
   {
   ...
   DialogSwitchLineType();
   virtual ~DialogSwitchLineType(void);
...
#endif //DIRECTOR_DIALOG_SWITCH_LINE_TYPE
