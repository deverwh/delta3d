...
function AddConfig(proj, strProjectName)
{
	try
	{
		...
		LinkTool.AdditionalDependencies = "dtCoreD.lib dtGameD.lib dtUtilD.lib dtABCD.lib osgD.lib";
		LinkTool.AdditionalLibraryDirectories = '$(DELTA_LIB)';
		LinkTool.OutputFile = '$(OutDir)\\' + strProjectName + 'D.exe';
		...
		//Add linker settings
		var LinkTool = config.Tools('VCLinkerTool');
		LinkTool.AdditionalDependencies = "dtCore.lib dtGame.lib dtUtil.lib dtABC.lib osg.lib";
		LinkTool.AdditionalLibraryDirectories = '$(DELTA_LIB)';
		LinkTool.OutputFile = '$(OutDir)\\' + '.exe';
